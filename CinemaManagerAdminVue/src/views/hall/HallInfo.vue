<template>
  <div>
    ...
    <el-card class="box-card">
      ...
      <el-row>
        <el-col :span="24">
          <el-button @click="getHallList"  style="font-size: 18px;">
             搜索
          </el-button>
        ...
        <el-table-column label="操作" width="360" fixed="right">
          <template slot-scope="scope">
            <el-tooltip effect="dark" content="修改影厅信息" placement="top" :enterable="false" :open-delay="500">
              <el-button type="primary" @click="isAbleEdit(scope.row.hallId)"  style="font-size: 18px;">
                 编辑
              </el-button>
            </el-tooltip>
            <el-tooltip effect="dark" content="删除影厅" placement="top" :enterable="false" :open-delay="500">
              <el-button type="danger"  style="font-size: 18px;"
                         @click="isAbleDelete(scope.row.hallId)">
                          删除
              </el-button>
            </el-tooltip>
            <el-tooltip effect="dark" content="安排座位" placement="top" :enterable="false" :open-delay="500">
              <el-button type="warning"  style="font-size: 18px;"
                         @click="arrangeSeat(scope.row.hallId)">
                          座位
              </el-button>
            </el-tooltip>
          </template>
    ...
    <el-dialog title="添加影厅" :visible.sync="addDialogVisible" width="60%" @close="addDialogClosed">
      ...
      <el-button type="primary" @click="addHall" style="font-size: 18px;">  确 定</el-button>
      </span>
    </el-dialog>
    ...
    <el-dialog title="修改影厅" :visible.sync="editDialogVisible" width="60%" @close="editDialogClosed">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="editHallInfo" style="font-size: 18px;">  确 定</el-button>
      </span>
    </el-dialog>
    ...
    <el-dialog title="安排座位" :visible.sync="arrangeDialogVisible" :width="arrangeDialogWidth">
      ...
      <br/>
      <div class="row" v-for="(value, key) in seats" :key="value">
        <span style="margin-right: 100px">{{key}}</span>
        <div style="display: flex; justify-content: flex-end">
          <span class="seat" :class="isSelected[seats[key][index]]" :key="index"
                @click="pressSeat(key, index)" v-for="(item, index) in value"></span>
        </div>
      </div>
      <span slot="footer" class="dialog-footer">
        <el-button @click="arrangeDialogVisible = false" style="font-size: 18px;">  取 消</el-button>
        <el-button type="primary" @click="saveSeat" style="font-size: 18px;">  确 定</el-button>
      </span>
    </el-dialog>
