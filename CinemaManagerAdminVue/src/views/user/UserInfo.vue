<template>
  <div>
    ...
    <el-card class="box-card">
      ...
      <el-row>
        <el-col :span="24">
          <el-button @click="getUserList" style="font-size: 18px;">
             搜索
          </el-button>
        ...
        <el-table-column label="操作" width="260" fixed="right">
          <template slot-scope="scope">
            <el-tooltip effect="dark" content="修改用户信息" placement="top" :enterable="false" :open-delay="500">
              <el-button type="primary" @click="showEditDialog(scope.row.userId)" style="font-size: 18px;">
                 编辑
              </el-button>
            </el-tooltip>
            <el-tooltip effect="dark" content="删除用户" placement="top" :enterable="false" :open-delay="500">
              <el-button type="danger" @click="deleteUserById(scope.row.userId)" style="font-size: 18px;">
                 删除
              </el-button>
            </el-tooltip>
          </template>
    ...
    <el-dialog title="添加用户" :visible.sync="addDialogVisible" width="60%" @close="addDialogClosed">
      ...
      <el-button type="primary" @click="addUser" style="font-size: 18px;">  确 定</el-button>
      </span>
    </el-dialog>
    ...
    <el-dialog title="修改用户信息" :visible.sync="editDialogVisible" width="60%" @close="editDialogClosed">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="editUserInfo" style="font-size: 18px;">  确 定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
